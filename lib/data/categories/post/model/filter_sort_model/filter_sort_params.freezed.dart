...
/// Adds pattern-matching-related methods to [FilterSortParams].
extension FilterSortParamsPatterns on FilterSortParams {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_FilterSortParams value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _FilterSortParams() when $default != null:
    ...
    switch (_that) {
      case _FilterSortParams() when $default != null:
        return $default(
            ...
            _that.limit,
            _that.lastCursor,
            _that.lastDateCursorForTieBreak);
      case _:
        return orElse();
    }
  }
